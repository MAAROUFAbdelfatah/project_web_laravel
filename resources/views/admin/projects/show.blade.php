...
@section('content')
    ...
    <div class="container col">
        ...
        <div class="text-center mb-3">
            ...
            <a href="{{route('projects_taches.create', $bp->id)}}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                href="{{route('projects_taches.edit', [$bp->id, $tache->id])}}">
                                                <i class="fas fa-pencil-alt">
                                                </i>
                                                     Modifier
                                                </a>
                                                <form style="display: contents;" method="post"
                                                    action="{{route('projects_taches.destroy', [$bp->id, $tache->id])}}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
    ...
    <div class="container col mt-5">
        ...
        <label class = "mt-3 ml-3">Les Articles </label>
        <div class="content">
            @include('inc.messages')
            <div class="container-fluid">
                <div class="row">
