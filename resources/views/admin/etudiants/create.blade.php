    ...
    <div class="container mg-5">
        ...
        <form method="POST" action={{route('etudiants.store')}} enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <label for="inputAppoger">Appogee</label>
                    <input name="appoger" type="text" class="form-control" placeholder="Appogee">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="tele" type="text" class="form-control" id="inputTele" placeholder="telephone">
                </div>
            </div>
